    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'super_Admin'), ('vendor', 'Vendor'), ('executive_user', 'Executive_User'), ('user', 'User')], default='user', max_length=50)),
                ('profile_pic', models.FileField(blank=True, null=True, upload_to='static/profile_pic')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('addresses', models.CharField(blank=True, max_length=255, null=True, verbose_name='Address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('super_admin', 'super_Admin'), ('vendor', 'Vendor'), ('executive_user', 'Executive_User'), ('user', 'User')], default='user', max_length=50, null=True)),
